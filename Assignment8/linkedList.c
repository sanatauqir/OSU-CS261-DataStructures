...
Author: Sana Tauqir
Date: 7/16/16
Description: Doubly-Linked List Deque and Back Implementations
***/
...
void linkedListAddFront(struct LinkedList* list, TYPE value)
{
	...
	list->frontSentinel->next->prev = newlink;	// the link after this new link has its prev point to it
